...
public class Constant {
    ...
    public static String INIT_VIDEO_URL = "http://10.7.87.224:8081/video/pagingVideo";//请求视频的url
    public static String ADD_HOT_URl = "http://10.7.87.224:8081/video/addHot";//点击小鱼干发送的Url
