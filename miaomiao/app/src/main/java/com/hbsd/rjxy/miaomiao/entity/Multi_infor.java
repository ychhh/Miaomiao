...
public class Multi_infor {
     ...
     * 视频的构造方法
     */
    public Multi_infor(int miId, int type, int catId, int userId, String miPath, Date miUpdateTime, String miContent, int miVisited, int miStatus, int miCommentCount, String miFormat, int miHot, int miAddress, String miCover, float miRecommended, String miTag) {
        this.miId = miId;
        this.type = type;
        this.catId = catId;
        this.userId = userId;
     ...
     * @return
     */
    public Multi_infor(int miId, int type, int catId, int userId, String miPath, Date miUpdateTime, String miContent, int miStatus, String miFormat, int miAddress, String miTag) {
        this.miId = miId;
        this.type = type;
        this.catId = catId;
        this.userId = userId;
     ...
     * @return
     */
    public Multi_infor(int miId, int type, int catId, int userId, Date miUpdateTime, String miContent, int miStatus, int miAddress) {
        this.miId = miId;
        this.type = type;
        this.catId = catId;
        this.userId = userId;
